...
//   return (
//     <div className="overflow-hidden relative border border-red w-full h-full">
...
//         {slides.map((s, i) => {
//           return (
//             <div key={i} className="min-w-full border border-red">
//               <img
//                 src={s}
//                 className="w-full h-auto border-solid" // Ensures the image takes up full width and maintains its aspect ratio
//               />
//             </div>
//           );
//         })}
